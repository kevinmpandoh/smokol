...
CREATE TABLE `master_barang` (
  ...
  `tahun_peroleh` date DEFAULT NULL,
...
INSERT INTO `master_barang` (`id`, `jenis`, `merk`, `tipe`, `tahun_peroleh`, `nomor_seri`, `nomor_urut_pendaftaran`) VALUES
...
INSERT INTO `users` (`id`, `nama_lengkap`, `email`, `nip`, `bidang`, `jabatan_id`, `role`, `username`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Admin Po', 'ponim@bps.go.id', '199810132021041001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'Tim IPDS', 'ponimin99', NULL, '$2y$10$o.NszZQtemnq5Q3wLGrrJuDU88ZYl2r2JAm1FtGp4X.kuYzY.U1CS', NULL, NULL, '2024-02-04 20:27:41'),
(5, 'Bagian Umum', 'umum7100@bps.go.id', '000000000000000000', 'Bagian Umum', 5, 'basic', 'admin_umum', NULL, '$2y$10$OoMnoV7hIy1tVbfzGRI4f.aSIdKv23XAavQcW789taf2iV0k/M1bm', NULL, NULL, NULL),
(178, 'Satria June Adwendi SST', 'satria.adwendi@bps.go.id', '199307102016021001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'awe', NULL, '$2y$10$r/qGcXIu8U88Anb6X5Eu6eL6pMnoeQwptEJQZ3BWOH5vYON84/J0K', NULL, NULL, NULL),
(179, 'Mia Wahyumiranti', 'miaw_miranti@bps.go.id', '198304112005022001', 'Bagian Umum', 5, 'basic', 'spk2', NULL, '$2y$10$IzUWHTnhi3At2ejTFTHJa.ZwwGc/vRzIV46BrTYj6DlmkcRak9FS2', NULL, NULL, NULL),
(180, 'Tiara Dameani S.ST', 'dame.simamora@bps.go.id', '198802082009122002', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'dame', NULL, '$2y$10$KdH36x5.o7dFLdswIKv4Een/S4a1MvH9STyYzQf/EDRrcWQfcfmNq', NULL, NULL, NULL),
(181, 'Hahotan Sagala SST', 'hase@bps.go.id', '198603202009021004', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'hahotan', NULL, '$2y$10$IBjH6uvkgrdEFezOFnOcw.H3GD59aA5mCI8Le3X1lh1xbo/axtd.K', NULL, NULL, NULL),
(182, 'Indira Anastasia Lolowang SE', 'indiraira@bps.go.id', '198301252003122001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'ira', NULL, '$2y$10$qcelzpbUN.GWcluNqhIm7eCXznV5Qcq/apQPko9OFa/YLQFXbQNKG', NULL, NULL, NULL),
(185, 'Erna Kusumawati SST', 'ernakusuma@bps.go.id', '198910192012112001', 'Bagian Umum', 5, 'basic', 'erna_kusumawati', NULL, '$2y$10$Kr94Sd.hf1Unq/mlBikHaefwnVTmsCoyGqyE09XNiHmH.56Q2ZBdW', NULL, NULL, NULL),
(186, 'Ir. Nuraini Walangadi', 'n.walangadi@bps.go.id', '196511231992122001', 'Bagian Umum', 5, 'basic', 'ani', NULL, '$2y$10$h8fK9i.EovKVsUJZ9iXAD.LwOz6uHFeM0z7ME5nRiW0siGa78f.Py', NULL, NULL, NULL),
(187, 'Simon Andreas August Remiasa S.ST', 'simon@bps.go.id', '197710111999121001', 'Bagian Umum', 5, 'basic', 'simon', NULL, '$2y$10$A9A.PZmX1CsLqNZ9j.Vmee6mxX4.tZ0T8dI6kqnja/idzUgU2CYbC', NULL, NULL, NULL),
(189, 'Hahotan Sagala SST', 'hase@bps.go.id', '198603202009021004', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'hase', NULL, '$2y$10$8X2DWJm30jOQ6ucdx5CW/.y4YbSqO78NJMsHym9OxjfLyfP54Bjve', NULL, NULL, NULL),
(190, 'Norma Olga Frida Regar, S.Si, M.Si', 'norma@bps.go.id', '196611291986032001', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'norma', NULL, '$2y$10$OibOvEgZNnoy.xPQ7V1MxeS1/oPcNWN/wpCexAGIBkWBngq/45GIK', NULL, NULL, NULL),
(191, 'Ratna Sulistyowati, SST, SAB, M.Si', 'ratnasuli@bps.go.id', '198505262008012001', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'ratna', NULL, '$2y$10$w2pCAKsFZWmyoE7gruOdWuiVY3f8qDzB6tHnvbpU8eB8jrrypBqoG', NULL, NULL, NULL),
(193, 'Titien Kristiningsih, SST, SE, M.Si', 'titienk@bps.go.id', '198005252002122003', 'Fungsi Statistik Sosial', 5, 'basic', 'titien', NULL, '$2y$10$7DRmgvCJXRluLOaTsh046uvu/Mn2PHQwNoyZIXJnk2uKJl.IEDVYi', NULL, NULL, NULL),
(194, 'Sarjani Harini Martiningsih S.Si', 'rhiniechay@bps.go.id', '198803062011012015', 'Fungsi Statistik Sosial', 5, 'basic', 'rhiniechay', NULL, '$2y$10$qnvDwgZj6h/uZ5ZlBe6tCeTlAKUzlfm4nRrH2wUU0TA1ogy44ypnm', NULL, NULL, NULL),
(195, 'Enggelin Giacinta Wongkar, SST', 'enggelingiacinta wongkar@bps.go.id', '199212292014122002', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'enggelin', NULL, '$2y$10$KhqmxuynKo58sSe4Tq1htOZ7vcZA9/p8Ly83nsQd1hvOyq2Z10/Sa', NULL, NULL, NULL),
(196, 'Ayu Puspita Wulandana B, SST', 'wulandanawulandana b@bps.go.id', '199010082014102001', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'wulandana', NULL, '$2y$10$MbKslvAaXDBhFH5DDCympuCFUfn6zme9gNHNIBwmcwhRBIo.A8DRO', NULL, NULL, NULL),
(197, 'Sirly Catharina Worotikan, SE., M.Si.', 'sirly@bps.go.id', '196808281994012001', 'Fungsi Statistik Produksi', 5, 'basic', 'sirly', NULL, '$2y$10$WPTqoPz7IoIGcrZ0iOV4kuJ8WJZ0Jgc5L.FzQiWYDipkR/b8B5KkO', NULL, NULL, NULL),
(198, 'Starry Nouva Solang, M.Si.', 'starrysolang@bps.go.id', '196709181994012001', 'Fungsi Statistik Produksi', 5, 'basic', 'starry', NULL, '$2y$10$Xx228KOg/qSOuH/xHeZBVOPTZJ0gJzlzOqkbIu/YJLrY4XLv6L7Wu', NULL, NULL, NULL),
(199, 'Victor Prima Sirait, SST., M.S.E', 'victorps@bps.go.id', '198103282006021001', 'Fungsi Statistik Produksi', 5, 'basic', 'victor', NULL, '$2y$10$C6Z2BmLXGawW2gddoRLbbuHHRQaOK3WcY/CosTWvPciRcdvTtB.gu', NULL, NULL, NULL),
(200, 'Oky Irwan Rosadi', 'oky@bps.go.id', '198610032011011011', 'Bagian Umum', 5, 'basic', 'oky', NULL, '$2y$10$8lRdoSiiLUNfZoBApCzcweS.yVa806vkTFEHF4r2FMXCHfj8YD7Ra', NULL, NULL, NULL),
(201, 'Mariane Esther Rantung, SST', 'mariane.rantung@bps.go.id', '199408062017012001', 'Fungsi Statistik Produksi', 5, 'basic', 'esther', NULL, '$2y$10$TNnGRElS.zPkXGCEY2bUgOVBbE9qYWmqIKf3r7CRaR5ghMwji3ICy', NULL, NULL, NULL),
(202, 'Abdullah Kango', 'akango@bps.go.id', '197407271997121001', 'Fungsi Statistik Distribusi', 5, 'basic', 'akango',  NULL, '$2y$10$m/3qq.0aIaGgzv8rDUhvNeJujnzFgcXUSCbBkMrQsWpbEIpxpEXyu', NULL, NULL, NULL),
(204, 'Elrini D. Wuisan, SE', 'elriniwuisan@bps.go.id', '198210022010032001', 'Fungsi Statistik Distribusi', 5, 'basic', 'elri', NULL, '$2y$10$j2avzft3gBeTuSrfPMgKdOlADahyjks4WQeB9qEOMGrgSx5sW0Wi6', NULL, NULL, NULL),
(205, 'Agnes M. Oroh', 'agnes.oroh@bps.go.id', '198208222008012014', 'Fungsi Statistik Distribusi', 5, 'basic', 'agnes', NULL, '$2y$10$DH1gFyiW/MYFHlTV.5xTteg1FsMI/Q6YDfEgffsNe0b6i.ncrkjiC', NULL, NULL, NULL),
(206, 'Firra Rastraaktiva Awaliyah S.Si', 'firra@bps.go.id', '198512142010032002', 'Fungsi Statistik Distribusi', 5, 'basic', 'firra', NULL, '$2y$10$y5lCZn4bhN9jvEeBwmAxm.atlqVTkWWDH5p6Pk3f.1laVPIShKooG', NULL, NULL, NULL),
(207, 'Limada Iqbal, SST', 'limada iqbal@bps.go.id', '199506222018021002', 'Fungsi Statistik Produksi', 5, 'basic', 'iqbal', NULL, '$2y$10$ECbHmuYiDSlKbzaEPN0C/.7wkatmqOiHOsOrQK.G9c2/giytLFFEa', NULL, NULL, NULL),
(208, 'Bregitta Sisilia Lasut SS', 'bregitta.lasut@bps.go.id', '198209182008012012', 'Sosial', 5, 'basic', 'gita', NULL, '$2y$10$7nw7eb3dLFkbs2Z2igfGdOGHBLdMDT6xoeInvTr9FRvFw89lP8jni', NULL, NULL, NULL),
(209, 'Junitha Sahureka', 'junitha@bps.go.id', '198606112009022007', 'Fungsi Statistik Sosial', 5, 'basic', 'uneth', NULL, '$2y$10$WbTBrBRN/5KpPfP/S3Fx8ukPkiAgOP4l6AT97lPBhUV4d96RPkw1u', NULL, NULL, NULL),
(210, 'Florentz Magdalena', 'fmagdalena@bps.go.id', '199108212014102000', 'Fungsi Statistik Sosial', 5, 'basic', 'florentz', NULL, '$2y$10$J4KWQs1RbFyvPgUz/6Dz5e2Wer/P6TuHi6wMxHgRWsBxzFN5IrWXe', NULL, NULL, NULL),
(211, 'Stela Engeline Doris Lomboan', 'stela@bps.go.id', '197209091992092001', 'Bagian Umum', 5, 'basic', 'stela', NULL, '$2y$10$2mmlgbGhVbmcxB4aygmNgeoduO4ejT97.9s8fTTinaBvGW0bOufI.', NULL, NULL, NULL),
(212, 'Joice Juliana Koyongian A.Md', 'joice.koyongian@bps.go.id', '198307062011012015', 'Bagian Umum', 5, 'basic', 'juliana', NULL, '$2y$10$X7cVoO7RSyznGedAfBI3LuxCeEnvBFr6miVh7aA.8iQbBIEPQpkj2', NULL, NULL, NULL),
(214, 'Frisda Arisanti T', 'frisda@bps.go.id', '198603082006042001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'frisda', NULL, '$2y$10$6y.vCTORK18bw6JjgQGw4OCQ4IA03ZAMYM23XZKkoErKrDb5MOCQ.', NULL, NULL, NULL),
(215, 'Tiara Dameani S.ST', 'dame.simamora@bps.go.id', '198802082009122002', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'dame_user', NULL, '$2y$10$1/3bUwS1EEDa5z3y6oXXc.KOn.wU9bMzqHwjUlWbe34Z77mPpbSFi', NULL, NULL, NULL),
(217, 'Prima Puspita Indramurti', 'prisma.puspita@bps.go.id', '', 'Bagian Umum', 5, 'basic', 'prima', NULL, '$2y$10$/lQPs/5fS9H0Vc3ufQ3QDu6Dk/Ik4DhumvG/PYSTZSX7tKArrdVxi', NULL, NULL, NULL),
(218, 'Priska Harto Lolowang', 'pika@bps.go.id', '198211262011011007', 'Bagian Umum', 5, 'basic', 'priska', NULL, '$2y$10$JOAyZeChBKpq3wURLg9zx.TWt28Q6DBZCYqNhJc9C9SJuTwt/LOCK', NULL, NULL, NULL),
(219, 'Uyun Rahmawati', 'uyun@bps.go.id', '198502132011012017', 'Bagian Umum', 5, 'basic', 'uyun', NULL, '$2y$10$acQ8L9qdffwSG8J5RT4Xg.isfDc0QqWbEDz8lGsnxm3UPo177fntm', NULL, NULL, NULL),
(220, 'Randy Pratama Lumenta', 'mentarandy@bps.go.id', '198911102012111001', '', 5, 'basic', 'randy', NULL, '$2y$10$nWBBSFl7mxnc4plty3.FCeWa1hNCXReL/KJYvNlKTlzGgkzhcoM46', NULL, NULL, NULL),
(234, 'Windha Wijaya, SST', 'windhawijaya@bps.go.id', '199008012014102001', 'Fungsi Statistik Distribusi', 5, 'basic', 'windha', NULL, '$2y$10$Xa8Y2xGbi.tlQzegwv.wPO92dRPCwohXzpROBWqvmF04A2191Qre2', NULL, NULL, NULL),
(235, 'Mohamad Samsodin', 'mohsam@bps.go.id', '198305082006021001', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'mohsam', NULL, '$2y$10$QStCvcYLw1xBXF43A5AuvuhF60/kCXiMUjIXMylDYT2rYzXqzbqOW', NULL, NULL, NULL),
(236, 'Sumbodo Aji Cahyono, S.Si, MA', 'sumbodo@bps.go.id', '197703081999011001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'sumbodo', NULL, '$2y$10$0TpwDCL/z8YI7mniejnCiOngK.ADrqN5JlDor1kFQ/xYSC3IBxRmG', NULL, NULL, NULL),
(237, 'Administrator', 'ipds7100@bps.go.id', '240171000000000000', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'admin', NULL, '$2y$10$ZsH7YI14/1TBjEIUajfPGusT/ZZBwg9Jlh5CE/JEBOxcQJnnmi1Ym', NULL, NULL, NULL),
(238, 'Radjid Dwi Iskandar A.Md', 'radjid@bps.go.id', '198504112011011009', 'Bagian Umum', 5, 'basic', 'radjid', NULL, '$2y$10$oJff9qkhvvMIp84ay1kQTejU/ux8/KztpxxwRw8k.yf0vI.xgsaKO', NULL, NULL, NULL),
(239, 'Yanti Jane Ivonne Kaeng', 'yajaivka@bps.go.id', '198201202008012012', 'Bagian Umum', 5, 'basic', 'spk1', NULL, '$2y$10$D43GkZ/tZ3ZFSqbwyRN36e7enJQWMv8GrUllmBxfKvK1SqIkw1h9e', NULL, NULL, NULL),
(241, 'Ridwan Setiawan S.Tr.Stat.', 'ridwanst@bps.go.id', '199604202019011002', 'Bagian Umum', 5, 'basic', 'Ridwan', NULL, '$2y$10$jikkFYXs1HztTkyKZGDJXuoZheI17exKsJl9XDNB.C7BlU6RMyR4O', NULL, NULL, NULL),
(242, 'Karni Hamdani S.Si.', 'karni.hamdani@bps.go.id', '199401312019032001', 'Bagian Umum', 5, 'basic', 'karni', NULL, '$2y$10$tS6Y7XZPoIN1cFwAWMyduO2kvYxTp8XHCGT5e6gf/m4PLkjxiubMe', NULL, NULL, NULL),
(243, 'Rosniar Eliana SST., M.Stat.', 'niar@bps.go.id', '198601202009022008', 'Fungsi Statistik Distribusi', 5, 'basic', 'niar', NULL, '$2y$10$Fk2umsmfchigEPpa73Kzp.ezrWy/2lJ2vV/bWFjpqUgs3JF3ZWuxu', NULL, NULL, NULL),
(244, 'Danty Welmin Yoshida Fatima S.Tr.Stat.', 'danty.fatima@bps.go.id', '199711032021042001', 'Fungsi Statistik Produksi', 5, 'basic', 'danty123', NULL, '$2y$10$PBjlV.CX/mo/vlUmVa5TTOkk5UW2D8TbDDWFudd2stFlNYiaE1Iw.', NULL, NULL, NULL),
(245, 'Inke Margareth Tambeo', 'inkemargareth@bps.go.id', '198403232007012003', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'inke', NULL, '$2y$10$TYWHFlLaiBgxRvYxGhaGkO9sHm3pSawVJ6Yo.x2Va.O/FOKB4sVci', NULL, NULL, NULL),
(246, 'Nurfadhila Fahmi', 'nurfadhila@bps.go.id', '199510092019032002', 'Fungsi Statistik Distribusi', 5, 'basic', 'dhila', NULL, '$2y$10$2ZcAMTjAXZyuQOUJZEO1CO4jOTB6R9r7Zo/Lq.5dwFe8pbUO9/FLy', NULL, NULL, NULL),
(247, 'Eko Siswahto SST, M.SE', 'xsiswahto@bps.go.id', '198504202008011003', 'Fungsi Statistik Produksi', 5, 'basic', 'xsiswahto', NULL, '$2y$10$5crcdl/KuFn2CzxG3bAVWeDEFCCvfTIB9pa0HcLXO3.uIIwKMtJ1e', NULL, NULL, NULL),
(249, 'Asim Saputra, SST, M.Ec.Dev.', 'asim@bps.go.id', '197609271999011001', 'Kepala BPS Provinsi', 5, 'basic', 'asim', NULL, '$2y$10$VyrMIDoRh2O0UzM/00zyQuP/o8xQALzXwC7xTNmTg2QVX699b3qBK', NULL, NULL, NULL),
(250, ' Anton Tri Wijayanto, S.ST, M.Si.', 'antontw@bps.go.id', '198001022002121003', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'Anton', NULL, '$2y$10$VrxwGqlr3drlgDKXOCxiWOwpTWKRLgncaqHJqiuL0I/qAAgLPW0IW', NULL, NULL, NULL),
(251, 'Dadan Sudarmadi, SST, M.Si.', 'dadan@bps.go.id', '197310141995121001', 'Bagian Umum', 5, 'basic', 'dadan', NULL, '$2y$10$kxnuRtvQ2znKGpj2NzDf7ezzudRR05noL5AeKxwBxTF9kLBmgJLQG', NULL, NULL, NULL),
(252, 'Abdul Aziz Makhrus, S.Tr.Stat.', 'amakhrus@bps.go.id ', '199607082019011003', 'Fungsi Statistik Sosial', 5, 'basic', 'aziz', NULL, '$2y$10$eEYYcn3cNfSypQN5fpIL4ePM5NlPwHnsmDO/CH9EF90yvi47/pXBa', NULL, NULL, NULL),
(253, 'Dina Atika Rahmawati, SST', 'dina.atika@bps.go.id', '199601152018022001', 'Fungsi Statistik Sosial', 5, 'basic', 'dina', NULL, '$2y$10$QDuUXhvfkFSs/lR9PzCsL...lr.C.KWUZqkt./z6ItSUqtzm8PGJe', NULL, NULL, NULL),
(254, 'Zulfa Nur Fajri Ramadhani, S.Tr.Stat.', 'zulfanr@bps.go.id', '199701292019012001', 'Fungsi Statistik Sosial', 5, 'basic', 'zulfa', NULL, '$2y$10$z1vfpAUc7bjMFpVPA1FfTeLGsu7AwtLy2htb0Qt3nSFAaI1xcV2hm', NULL, NULL, NULL),
(255, 'Salonica Oktaviani, SST', 'salonica.oktaviani@bps.go.id ', '199410302018022001', 'Fungsi Statistik Sosial', 5, 'basic', 'salonica', NULL, '$2y$10$SkF1XX/EgBkabpxILMrbE.MpC8ODEE3QhTjbXeZslfS6kZ7.e.trS', NULL, NULL, NULL),
(256, 'Christian Leonardo Pratama Tamboto, S.Tr.Stat.', 'leonardo.pratama@bps.go.id', '199708072019121001', 'Bagian Umum', 5, 'basic', 'christian', NULL, '$2y$10$Ce21FWAvpbeX7tfGtuGkkObtXOIcOVxXo1eIv6HBFD0dmXFEM328a', NULL, NULL, NULL),
(257, 'Untari Rahmawati, S.Tr.Stat.', 'untarirahma@bps.go.id', '199603312019012001', 'Fungsi Neraca Wilayah dan Analisis Statistik', 5, 'basic', 'Untari', NULL, '$2y$10$0AoKdXrA3MXGE7/23qAEH.K68nfISx0Lfr6kPZSk8HUPfrEXk.1zK', NULL, NULL, NULL),
(258, 'I Nyoman Pande Suputra, SST', 'in.pande@bps.go.id', '199504272018021002', 'Fungsi Statistik Produksi', 5, 'basic', 'Pande', NULL, '$2y$10$ok8heweZKlFoc4P72oWGHeTWPuWqmTUzvLTan3Ilz7lFdTa9oTKt6', NULL, NULL, NULL),
(259, 'Nabella Intan Karasta, S.Tr.Stat', 'nabella.intan@bps.go.id', '196808281994012001', 'Fungsi Statistik Produksi', 5, 'basic', 'nabella', NULL, '$2y$10$v2d7tbUTUn3xisqF87cdweqduh2BR/1Nbl5tFj4TaYG0wj8JPlCmC', NULL, NULL, NULL),
(260, 'Yulius Wendi Triandaru SST', 'yulius.wendi@bps.go.id', '199407252018021001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'Yulius', NULL, '$2y$10$IY1HcgPuRsVvstEXiWBPCO8f1vF1Z7FDm9InCMGZXK0y.ZSRvrjw.', NULL, NULL, NULL),
(261, 'Nurul Hidayah S.Tr.Stat.', 'nurul.hidayah@bps.go.id', '199704212019012001', 'Bagian Umum', 5, 'basic', 'ida', NULL, '$2y$10$X6kdU0rHDiVkuagLRyYWYulXDe6P4cyQnc4bhtKLoq.XkmFrfOPxK', NULL, NULL, NULL),
(262, 'Wisnu Triaji, SE', 'wisnu.triaji@bps.go.id', '198702142009021002', 'Bagian Umum', 5, 'basic', 'wisnu.triaji', NULL, '$2y$10$RbMQkufm6beVBCV/jpEa7OXQQfOaZ2f2gS0eofwKhujtYGio97XZm', NULL, NULL, NULL),
(266, 'Irene Ruth Longkutoy SH', 'airin@bps.go.id', '197403242006042000', 'Bagian Umum', 5, 'basic', 'irene', NULL, '$2y$10$16yRqjz0VMBxfVQ.foWRZ.YvVfoRnuB5B91Hp/vGjZKspdHLFNicS', NULL, NULL, NULL),
(267, 'Steven Kalvin Montolalu, SE', 'stevenmontolalu@bps.go.id', '197904062003121000', 'Bagian Umum', 5, 'basic', 'steven', NULL, '$2y$10$CIggM.4KsSMFc1UHEjT2FOXQBPx/1srtVz.IF3O9d.AtDf2fuGgsW', NULL, NULL, NULL),
(268, 'Lazia Outenty Bimbangnaung', 'tenty@bps.go.id', '198110000000000000', 'Bagian Umum', 5, 'basic', 'lazia', NULL, '$2y$10$UsfMc.OaYoEtyvvOHm00wO0nlBrTr5EyqVnD6GqWbDYdugsNVihLe', NULL, NULL, NULL),
(269, 'Olfiane Silfia Pelealu, SE', 'olfianesilfia pelealu@bps.go.id', '197310042003122000', 'Fungsi Statistik Sosial', 5, 'basic', 'olfiane', NULL, '$2y$10$xBHEuQB/OrrQ0jqTvD3hD.2HUPrlmnnLj4ZYJcMbu0iptzAHaOn2K', NULL, NULL, NULL),
(271, 'Elrini Diane Wuisan, SE', 'elriniwuisan@bps.go.id', '198210022010032000', 'Fungsi Statistik Distribusi', 5, 'basic', 'elrini', NULL, '$2y$10$YG9WBJzq5igTImCJrbVuGOlqFtLHBLxnEeegnp44oS.QP6KSNZ9F.', NULL, NULL, NULL),
(272, 'Vonny Joice Lalujan, SE', 'vonny@bps.go.id', '196911011992022000', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'vonny', NULL, '$2y$10$fQDCpvGPiEkfeV4V3PtYJ.e0F70STcOoakx.8umhvqD4tOgpYSY4K', NULL, NULL, NULL),
(273, 'Dading, S.Si.', 'dading@bps.go.id', '199112202019031000', 'Fungsi Statistik Distribusi', 5, 'basic', 'dading', NULL, '$2y$10$MjrdI8EnpKNjlG1ptWbciuo91Jnz.3H2uny/0eDBvgFIvjGwNmj0K', NULL, NULL, NULL),
(274, 'Muhammad Iqbal, S.Stat.', 'iqbal.muh@bps.go.id', '199510132019031001', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'iqbal1', NULL, '$2y$10$BOVHR7MUyGPORtDZBDfLbuj8CHBgG9cvvyT.4CBKD8mEmk8ar9Lu2', NULL, NULL, NULL),
(275, 'Ponimin', 'ponim@bps.go.id', '199810132021041000', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'Ponimin', NULL, '$2y$10$D8M4i/FUluU2a8khu05ND.Ms4nzqJHNjKhC9GRW3ZNMBaprlGpYni', NULL, NULL, NULL),
(276, 'Muhammad Rifqi Mubarak', 'rifqi.mubarak@bps.go.id', '199901052021041000', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'Rifqi', NULL, '$2y$10$iLGCRpmYlu0ZdxYcHPMomOYZvIrk9hMGTdrAXoqDAaYEIlGukAp7W', NULL, NULL, NULL),
(283, 'Ririn Hidayati S.Si., MPP, MSE', 'ririnh@bps.go.id', '197311031998032005', 'Fungsi Distribusi', 5, 'basic', 'ririnh', NULL, '$2y$10$efK62i/kYfkoLpn4SEsAdedHcEmFjgczUFY8YiaiNQ3cIRZKQyB1e', NULL, NULL, NULL),
(284, 'Sarjani Harini Martiningsih S.Si', 'rhiniechay@bps.go.id', '198803062011012015', 'Seksi Statistik Pertambangan, Energi dan Konstruksi', 5, 'basic', 'rini123', NULL, '$2y$10$LZwNgB4xx7EaV0ARZvmMIe.ekj4t72kwgMMteZ.NK2cjv5ZzbrXOC', NULL, NULL, NULL),
(287, 'Mustika Aridya Arum A.Md.Kb.N.', 'mustika.arum@bps.go.id', '200104112022012001', 'Bagian Tata Usaha', 5, 'basic', 'mustika', NULL, '$2y$10$RAgJ5uiYm7hx9TM31sxRfulCfagNKU3yjRpVVLkpkrYu/JjWA2Vzi', NULL, NULL, NULL),
(288, 'Ratriani Retno Wardani S.Tr.Stat.', 'ratriani.wardani@bps.go.id', '199903202022012004', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'ratriani', NULL, '$2y$10$eclXs8xxiq/AdnV8P8jBnOh7i/64Kf0kYFlEXh9aq018opCpPtpZK', NULL, NULL, NULL),
(289, 'Daniel Tri Hemawan SE', 'daniel.tri@bps.go.id', '197610102006041003', 'Fungsi Neraca Wilayah dan Analisis', 5, 'basic', 'daniel_tri', NULL, '$2y$10$rQV9B4Oe0xl4ByXFDk.BBuiMOVR5lymi7pn/9kVKqiogH3i08cdNS', NULL, NULL, NULL),
(290, 'Yola Christhy Larinse SST', 'yola.larinse@bps.go.id', '199211072014122001', 'Fungsi Statistik Produksi', 5, 'basic', 'yola', NULL, '$2y$10$JDFz3l0gi7Vj9Y9BJ4NVl.DymC0oHa3N1WZEhGNAt0Yio.rd1pdaS', NULL, NULL, NULL),
(291, 'Risky SST', 'risky@bps.go.id', '199405192016021001', 'Fungsi Statistik Sosial', 5, 'basic', 'risky', NULL, '$2y$10$zd0DPQJDVR.RQOYsHjLWd.Mt.MxWPfuBg413JIzgVbAumEoTjHwlu', NULL, NULL, NULL),
(292, 'Zaenuri Putro Utomo', 'zaenuri@bps.go.id', '198101262011011005', 'Fungsi Integrasi Pengolahan dan Diseminasi Statistik', 5, 'basic', 'zaenuri', NULL, '$2y$10$h3s.oFI2w/abO0tbgFsK1uVXErxOyDPe1LeGseVhUGvOOnGZD6YGS', NULL, NULL, NULL),
(293, 'Herman Tinungki SE', 'herman.tinungki@bps.go.id', '196703311986031002', 'Bagian Umum', 5, 'basic', 'herman', NULL, '$2y$10$l9e7ZRcb0hsFOkhbGZ8GkO2SfEefkdnxiqOwp8TqT83JLkhahPyLi', NULL, NULL, NULL),
(294, 'Nurul Hayati Unonongo SST', 'nurul.unonongo@bps.go.id', '199311112017012002', 'Bagian Umum', 5, 'basic', 'nurul.unonongo', NULL, '$2y$10$o3DsIrKRpw1SdXnyK0W7HuGPakLKNBk6k1XYDMsQZ0GFtCYYeY6/W', NULL, NULL, NULL),
(295, 'Friska Patricia Raintung, SE', 'friska.patricia@bps.go.id', '198912292022032007', 'Bagian Umum', 5, 'basic', 'friska.patricia', NULL, '$2y$10$WjvKjtFgZX.WgyV21S1vF.hR5LJ.LLUGHqH2yDjwCIA3baf3daNza', NULL, NULL, NULL),
(296, 'Nova Nurviana SST, M.T.', 'nova.nurviana@bps.go.id', '198911222013112001', 'Statistik Sosial', 5, 'basic', 'nova.nurviana', NULL, '$2y$10$bwsm.6YDvSgBF46NBJr9X.KJW5In0hLK9fT7OhKAWc7xzr5p9ArTu', NULL, NULL, NULL),
(298, 'ponim Ponimin', 'user@bps.go.id', '199', 'IPDS', 8, 'Super Admin', 'adminsuper', NULL, '$2y$10$h77SI0N.GYAfTa1z597A2O0Cu3hnL3hArHBwyLZK69AGQ.SsRJr9G', NULL, '2024-02-05 03:48:33', '2024-02-05 03:48:33');
